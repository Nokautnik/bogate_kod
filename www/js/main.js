...
function accountResult() {
   ...
   var countingOffices = 0;
    if((text.split("GROSZEK").length - 1) > 0){
       countingOffices++};
    if((text.split("KARMELICKA").length - 1) > 0){
        countingOffices++};
    if((text.split("BAKSY").length - 1) > 0){
        countingOffices++};
    if((text.split("FUTURA PARK").length - 1) > 0){
        countingOffices++};
    if((text.split("EXCHANGE").length - 1) > 0){
        countingOffices++};
    if((text.split("CENTUS").length - 1) > 0){
        countingOffices++};
    if((text.split("PARANA").length - 1) > 0){
        countingOffices++};
    if((text.split("GRODZKA").length - 1) > 0){
        countingOffices++};
    if((text.split("AGATKA").length - 1) > 0){
        countingOffices++};
    if((text.split("2XJ JERZY HUDAK").length - 1) > 0){
        countingOffices++};
    if((text.split("UNION STANDARD").length - 1) > 0){
        countingOffices++};
    if((text.split("GROSZ ").length - 1) > 0){
        countingOffices++};
    if((text.split("VABANQUE").length - 1) > 0){
        countingOffices++};
    if((text.split("INPULS TRADING").length - 1) > 0){
        countingOffices++};
    if((text.split("IDZIO").length - 1) > 0){
        countingOffices++};
    if((text.split("DOTUS").length - 1) > 0){
        countingOffices++};
    if((text.split("BIURA WYMIANY WALUT ŁODZIŃSCY").length - 1) > 0){
        countingOffices++};
    if((text.split("INNY").length - 1) > 0){
        countingOffices++};    
   
  //  JSON.stringify(object, "GROSZEK"&&"KARMELICKA");

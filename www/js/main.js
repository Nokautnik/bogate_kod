...
function showCurrency() {
    ...
    for (var i = 0; i < obj.length; i++) {
        ...
        this.createElementDiv(div, "Currency",  obj[i].waluta);
...
function showTransactionAmount() {
    ...
    for (var i = 0; i < obj.length; i++) {
        ...
        this.createElementDiv(div, "Amount", obj[i].ilosc );
...
function showExchangeValueCurrency() {
    text = localStorage.getItem("userHistory");
    obj = JSON.parse(text);
    document.getElementById('historyID').innerHTML = "";
    var body = document.getElementsByTagName('body')[0];
    for (var i = 0; i < obj.length; i++) {
        ...
        var container = document.querySelector("#euro");
        var matches = container.querySelectorAll("div.highlighted > p");    
        this.createElementDiv(div, "Value", "Na kwotę: " + obj[i].wartosc + " zł");

        body.appendChild(div);
    }
}

function showNumberOfEchangeOffices() {
    text = localStorage.getItem("userHistory");
    obj = JSON.parse(text);
    document.getElementById('historyID').innerHTML = "";
    var body = document.getElementsByTagName('body')[0];
    for (var i = 0; i < obj.length; i++) {
        ...
        this.createElementDiv(div, "Offices", "W kantorze: " + obj[i].kantor);
        body.appendChild(div);
    }
}
...
function showAmount() {
    ...
    for (var i = 0; i < obj.length; i++) {
        ...
        var Sum = 0;
        for (var i in obj){
            Sum += parseInt(obj[i].wartosc);
  }      
        this.createElementDiv(div, "Amount", Sum);
        this.createElementDiv(div, "Amount1", obj.length);
        body.appendChild(div);
    }
}